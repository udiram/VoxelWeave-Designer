...
describe('normalizeRelease', () => {
  it('maps Apple Silicon assets, checksums, source revision, and evidence', () => {
    const release: GitHubRelease = {
      ...
      html_url: 'https://github.com/udiram/VoxelWeave/releases/tag/v0.1.0',
      assets: [
        {
        ...
        },
        {
          name: 'checksums.txt',
          size: 128,
          browser_download_url: 'https://github.com/udiram/VoxelWeave/releases/download/v0.1.0/checksums.txt'
        }
      ]
    };
    const view = normalizeRelease(release, 'udiram/VoxelWeave');
    ...
    expect(view.releaseUrl).toBe('https://github.com/udiram/VoxelWeave/releases/tag/v0.1.0');
